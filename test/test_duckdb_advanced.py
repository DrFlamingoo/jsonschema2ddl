...
def test_duckdb_mixed_pk_types(duckdb_db):
    ...
    # Insert data
    cursor.execute('INSERT INTO "mixed_pk"."manual_pk_table" (code, description) VALUES (?, ?)', 
                   ("CODE1", "First code"))
    cursor.execute('INSERT INTO "mixed_pk"."manual_pk_table" (code, description) VALUES (?, ?)', 
                   ("CODE2", "Second code"))
    ...
    # Verify results
    manual_result = cursor.execute('SELECT code, description FROM "mixed_pk"."manual_pk_table" ORDER BY code').fetchall()
